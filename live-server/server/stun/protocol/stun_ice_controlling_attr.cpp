...
size_t StunIceControllingAttr::size()
{
    return StunMsgAttr::size() + 4;
}

int32_t StunIceControllingAttr::encode(uint8_t *data, size_t len)
{
...
int32_t StunIceControllingAttr::decode(uint8_t *data, size_t len)
{
    uint8_t *data_start = data;
