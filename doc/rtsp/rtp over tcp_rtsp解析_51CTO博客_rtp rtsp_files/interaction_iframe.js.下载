...
function CreateIframe(config){
    ...
    CreateIframe.prototype.openIframe = function(){
        if(!document.getElementById("login_iframe_mask")){
            ...
            div.innerHTML = '<div id="login_iframe" class="login_iframe"><div class="close_icon"><img src="https://s1.51ctocdn.cn/images/202108/06/fdf9873006a1349db7dc6c19fdac16f5.png" /></div><iframe id="idFrame" name="idFrame" src='+iframeUrl+'  frameborder="0" scrolling="auto" ></iframe></div>';
